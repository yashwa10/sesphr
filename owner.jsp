    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        ...
        <ul>
          ...
          <li class="active"><a href="owner.jsp"><span>Owner</span></a></li>
      ...
      <div class="clr"></div>
      <div class="slider">
        <div id="coin-slider"> <a href="#"><img src="img/o2.jpg" width="960" height="320" alt="" /> </a> <a href="#"><img src="img/o1.jpg" width="960" height="320" alt="" /> </a> <a href="#"><img src="img/o3.jpg" width="960" height="320" alt="" /> </a> </div>
        <div class="clr"></div>
      </div>
      <div class="clr"></div>
    </div>
...
<center><div class="article">
          <h2><span>Owner</span> Login</h2>
          <div class="clr"></div>
          <form action="loginaction.jsp" method="get" id="sendemail">
            <ol>
              <li>
                  <input id="name" type="text" name="uname" placeholder="Enter Youe User Name" class="text" required=""/>
              </li><br>
              <li>
                  <input id="email" type="password" name="pass" placeholder="Password" class="text" required=""/>
              </li><br>
              <li>
                  <input id="email" type="password" name="secret" placeholder="Secret Key" class="text" required=""/>
              </li>
                   <input type="hidden" value="2" name="status" />
              <li>
                <input type="image" name="imageField" id="imageField" src="img/sub1.png" class="send" />
                <div class="clr"></div>
