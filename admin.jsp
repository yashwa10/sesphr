...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="clr"></div>
      <div class="slider">
        <div id="coin-slider"> <a href="#"><img src="img/a3.jpg" width="960" height="320" alt="" /> </a> <a href="#"><img src="img/a1.jpg" width="960" height="320" alt="" /> </a> <a href="#"><img src="img/a2.jpg" width="960" height="320" alt="" /> </a> </div>
        <div class="clr"></div>
      </div>
      <div class="clr"></div>
    </div>
...
<center><div class="article">
          ...
          <form action="loginaction.jsp" method="get" id="sendemail">
            <ol>
              <li>
                  <input id="name" type="text" name="uname" placeholder="Admin ID" class="text" required=""/>
              </li><br>
              <li>
