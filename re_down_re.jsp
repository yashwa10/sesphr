<%-- 
    Document   : re_down_re
    Created on : May 15, 2016, 12:00:31 PM
    Author     : java4
--%>
...
<!--          <li><a href="admin_home.jsp"><span>Admin Home</span></a></li>
          ...
          <li><a href="re_down.jsp"><span>Back</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
                    ...
                    <div style="border: 1px solid white;height: 350px;border-top-width: 20px;border-bottom-width: 10px">
                        ...
                        <table border="1" style="text-align: center;margin-left: 320px">
                            ...
                            <tr>
                               <%int fid=0;
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("select * from patient_details where master_key LIKE '%" + search + "%'");
                                    if (rs.next()) {
                            ...
                            %>
                                ...
                                <td> <a href="download_re?<%=rs.getString("id")%>"><font style="color: green">Download</a></font> </td>   
                                        <tr />
                                                               <% }while (rs.next());%>
                                     
                                     <% }else{ 
                                        response.sendRedirect("other3.jsp");
