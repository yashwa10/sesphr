      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="research_de.jsp"><span>Researcher Details</span></a></li>
           ...
           <li class="active"><a href="researcher_req.jsp"><span>Researcher Request</span></a></li>
                    ...
                    <div style="border: 1px solid white;height: 350px;border-top-width: 20px;border-bottom-width: 10px">
                        ...
                        <table border="1" style="text-align: center;margin-left: 80px">
                            <tr>
                                ...
                                <th style="text-align: center;width: 60px;">Categories</th>
                                <th style="text-align: center;width: 100px;">File Name</th>
                                <th style="text-align: center; width: 100px;">Secret Key</th>
                            </tr>
                            <tr>
                                <%
                                    Connection con = null;
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("select * from request where status='Not_Allowed'");
                                        while(rs.next())
                                ...
                                <td> <a href="r_mail.jsp?<%=rs.getString("id")%>"><font style="color: green">Send</a></font> </td>   
                                        <tr />
                                        <%} 
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
