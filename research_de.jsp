    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="research_de.jsp"><span>Researcher Details</span></a></li>
           <li><a href="user_req.jsp"><span>User Request</span></a></li>
           <li><a href="researcher_req.jsp"><span>Researcher Request</span></a></li>
           <li><a href="download_de.jsp"><span>Downloaded file</span></a></li>
            ...
            <div class="row">
                <div class="box" style="height: 400px;">
                    ...
                    <div style="border: 1px solid white;height: 350px;border-top-width: 20px;border-bottom-width: 10px">
                        <center><h3>Researcher Details</h3></center><br />
                        <table border="1" style="text-align: center;margin-left: 80px">
                            <tr>
                                <th style="text-align: center;width: 30px;">User ID</th>
                                <th style="text-align: center;width: 70px;">User Name</th>
                                <th style="text-align: center;width: 300px;">Email</th>
                                <th style="text-align: center;width: 100px;">First Name</th>
                                <th style="text-align: center;width: 120px;">Last Name</th>
                                <th style="text-align: center;width: 100px;">Street</th>
                            ...
                            <tr>
                                <%
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("select * from registration where role='researcher'");
                                        while(rs.next())
